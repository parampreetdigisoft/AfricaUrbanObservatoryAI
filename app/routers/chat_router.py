...
async def get_emerging_trends_and_issues(
    ...
    """
    Public homepage feed for emerging African urban risks and stability trends.

    Returns structured African city cards suitable for a public-facing UI.
    """
    try:
...
@router.get(
    ...
    summary="Live African AUI pillar signals (all 14 pillars)",
)
    

async def get_pillar_live_signals():
    """
    Public feed: one concise live African urban signal per African Urban Index pillar (IDs 1–14).
    """
    try:
