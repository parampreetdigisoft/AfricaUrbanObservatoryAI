...
# Create FastAPI app
app = FastAPI(
    title="African Urban Index AI Service",
...
async def custom_swagger_ui_html():
    return get_swagger_ui_html(
        ...
        title="African Urban Index AI Service - Swagger UI",
...
async def redoc_html():
    ...
    return get_redoc_html(
        openapi_url="/openapi.json",
        title="African Urban Index AI Service - ReDoc"
    )
...
async def root():
    return {
        "service": "African Urban Index AI Service",
        "status": "running",
