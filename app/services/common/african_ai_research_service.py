"""
    African Urban Index AI Research Service
    ...
    async def initialize(self):
        ...
        for attempt in range(self.max_retries):
            try:
                ...
                logger.info(f"African Urban Index AI Research Service initialized with {settings.LLM_PROVIDER}")
                return
    ...
    async def research_and_score_city(
        ...
        try:
            ...
            prompt = ChatPromptTemplate.from_messages([
                ...
                SEARCH THE WEB comprehensively for city-level data. Synthesize findings across all 14 pillars. Provide holistic African Urban Index evaluation with clear evidence.""")
            ])
