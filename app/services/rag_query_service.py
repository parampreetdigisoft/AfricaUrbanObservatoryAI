...
All prompt text comes from AUIPromptTemplates.
"""
...
class RAGQueryService:
    ...
    Prompt text lives in AUIPromptTemplates.
    """
...
# ============================================================
        ...
        try:
            ...
            if isinstance(cards, list):
                ...
                for c in cards:
                    ...
                    if not VerdianPromptTemplates.is_african_city_card(
            ...
            if not analysis.get("cities"):
                raise ValueError("No African city cards produced from GDELT articles")
    ...
    async def pillar_live_signals(self) -> Dict[str, Any]:
        try:
            ...
            user_template = """
            Generate the LIVE African AUI pillar signals feed (all 14 pillars).
            ...
            - Each signal MUST be about an African city, African country, or African urban system.
